"""
Code to Evaluate of using the Mean Absolute Scaled Error (MASE)
...
def evaluate(model, test_data, return_lists=False):
    """
    Evaluate the model's forecasting ability on the test set.
    Samples are drawn from the test set using a sliding window
